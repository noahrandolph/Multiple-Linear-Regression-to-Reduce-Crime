...
Crime rate depends on the effectiveness of the criminal justice system and economic factors. Within the criminal justice system, _police_ _probconv_ is 
...
model1 = lm(scaledcrime ~ scaledpolice + pctsen + pctconv)
AIC1 = AIC(model1)
plot(model1)
summary(model1)
vif(model1)
