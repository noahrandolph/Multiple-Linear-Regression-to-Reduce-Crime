...
model1 = lm(scaledcrime ~ log(police) + probsen + probconv)
AIC1 = AIC(model1)
plot(model1)
...
```{r}
model2 = lm(scaledcrime ~ log(police)+ probsen + probconv + density + pctmin +
                    probconv)
AIC2 = AIC(model2)
plot(model2)
vif(model2)
...
```{r}
model3 = lm(scaledcrime ~ log(police) + probsen + probconv + density + pctmin  +
