...
The common way to report crimes is per 1000 people, so we'll do that here for readability. To make police consistent with _crime_, we scale _police_ as well.
